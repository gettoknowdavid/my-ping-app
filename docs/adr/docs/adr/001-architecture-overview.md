...
- [`watch-it`](https://flutter-it.dev/documentation/watch_it/getting_started) for automatic rebuilds in the Flutter
  widgets
- [`command-it`](https://flutter-it.dev/documentation/command_it/getting_started) for state management based on
  `ValueListenable` and `Command` design pattern
- [`listen-it`](https://flutter-it.dev/documentation/listen_it/getting_started) for reactive collections and operators
  to be used with `ValueListenable`
